...
var memberList = [
    ...
    //26
    {
        name: '栋夷',
        prayer: [
            {text: '与神有亲密的关系，求神帮助来坚固；'},
            {text: '天气比较炎热，求神预备安静的时间，帮助我在读经和祷告的事上，不要体恤自己的肉体，而是继续坚持每天读经和祷告。'},
            {text: ''}
        ],
    ...
    //26
    {
        name: '蒙恩',
        prayer: [
            {text: '今晚继续写5+5作业，求主怜悯保守；从明天开始我所在的部门会很忙碌，求主让我在忙碌中不烦躁，有细心依靠主。'},
            {text: ''},
            {text: ''}
        ],
...
//     26
    ...
    //26
    {
        name: '锦艳',
        prayer: [
            {text: '愿主保守看顾我的心，让我不要懒惰，不要总是在犯错时找借口，让我学会勇敢，在家中做好榜样，学会宽容和舍己。'},
            {text: '求主赐予我力量让我顺利通过7月11号的科目四考试。'},
            {text: ''}
        ],
    ...
    //26
    {
        name: '炳林',
        prayer: [
            {text: '为我能够愿意多一点时间用来读经这件事祷告，我现在肯花在读经的时间太少了，希望自己可以多一点时间用在读经上面。'},
            {text: ''},
            {text: ''}
        ],
