...
var memberList = [
    ...
    // 26
    {
        ...
        update: true, //本周是否更新
        prayer: [
            {text: '使从舟在一星期的集体生活中养成快速洗漱的良好生活习惯；'},
            {text: '使从舟在同学面前勇敢承认自己是基督徒，荣耀主的名；'},
            {text: '周三周四和杨叔杨妈一起回老家看望主内弟兄姐妹，求主坚固他们的信仰。'}
        ],
...
// 2、希望我老婆秋萍和小孩都能平安成长。
    {
        ...
        update: true, //本周是否更新
        prayer: [
            {text: '希望秋萍和宝宝再接下去日子可以健康平安，生产也希望顺利，求主保守；'},
            {text: '工作上也希望自己可以荣耀神，能平复自己情绪面对委屈和羞辱。'},
            {text: ''},
            {text: ''}
        ],
        birthdayCD:tarTimeR(''),
