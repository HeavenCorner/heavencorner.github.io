...
var memberList = [
    ...
    //26
    {
        name: '栋夷',
        prayer: [
            {text: '求神带领我，恢复与他亲密的关系；'},
            {text: '每天也预备我安静的时间，可以为家人，朋友，事工来代祷。'},
            {text: ''}
        ],
    ...
    //26
    {
        ...
        prayer: [
            ...
            {text: '求神预备郝叔叔、阿姨的心，拣选他们信靠神；求神医治阿姨的眼睛。'}
        ],
...
//     26
    ...
    },
    {
        name: '思思',
        prayer: [
            {text: '26号都有驾照考试，希望能全部顺利通过，然后预备月底去上海投入新的工作。'},
            {text: ''},
            {text: ''}
        ],
    ...
    //26
    {
        name: '炳林',
        prayer: [
            {text: '为我能够坚持去每天锻炼身体和读经祷告这件事祷告，希望可以坚持继续。'},
            {text: ''},
            {text: ''}
        ],
